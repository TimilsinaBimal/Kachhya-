...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insertdata(Data data){
        ...
        values.put(COL_2, data.getFname());
        values.put(COL_3, data.getLname());
        values.put(COL_4, data.getDepart());
        values.put(COL_5, data.getYear());
        values.put(COL_6, data.getSemester());
        values.put(COL_7, data.getDobday());
        values.put(COL_8, data.getDobmonth());
        values.put(COL_9, data.getDobyear());
        values.put(COL_10, data.getGender());
        values.put(COL_11, data.getEmail());
        values.put(COL_12, data.getPhoneNumber());
        values.put(COL_13, data.getPassword());
